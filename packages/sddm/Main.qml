...
Rectangle {
    ...
    FontLoader { id: fontRegular; source: "assets/fonts/JetBrainsMonoNerdFont-Regular.ttf" }
    FontLoader { id: fontMedium; source: "assets/fonts/JetBrainsMonoNerdFont-Medium.ttf" }
    FontLoader { id: fontBold; source: "assets/fonts/JetBrainsMonoNerdFont-Bold.ttf" }
