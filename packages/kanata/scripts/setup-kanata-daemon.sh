...
KANATA_CONFIG_REL_PATH="repos/kanata/staggered.kbd"

# System location where the kanata config file will be placed
# (DO NOT EDIT)
SYSTEM_KANATA_CONFIG_DST="/etc/kanata/$KANATA_CONFIG_REL_PATH"
...
[Unit]
Description=Kanata keyboard remapper for $KANATA_CONFIG_REL_PATH
